  ...
  return (
    <div>
      <div className="App">
        <a
          href={
            "mailto:franciskopereira@hotmail.com?subject=SendMail&body=Description"
          }
      ...
      <div className="navbar">
        ...
        <ul className="navlinks">
          ...
          <div className="menu">
            <li>Home</li>-<li>projectos / works</li>-<li>sobre / about</li>-
      ...
      <div style={{ display: "flex" }}>
        ...
        <div style={{ color: "rgb(116, 76, 36)", marginTop: "-1rem" }}>
          <div className="accordion">
            <div className="accordion-item">
              ...
              >
                ...
                <div style={{ color: "rgb(116, 76, 36)", fontWeight: "bold" }}>
                  {isActive1 ? "-" : "+"}
                </div>
              </div>
              {isActive1 && (
                <div
                  ...
                  style={{ color: "rgb(116, 76, 36)", fontSize: 10 }}
                >
                  {content1}
                </div>
              )}
